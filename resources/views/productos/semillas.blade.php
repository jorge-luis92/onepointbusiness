...
<div class="container">
    ...
    <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab" aria-controls="settings" aria-selected="false">Estadisticas</a>
      ...
      <table class="table table-bordered table-striped" style="color: #000000;" id="semillas_read">
        <thead>
          <tr>
                 ...
                 <div class="modal-dialog modal-dialog-centered">
                   <div class="modal-content">
                     ...
                     <div class="modal-body">
                       <form method="POST" action="{{ route('actualizarpreciosemilla') }}">
                           @csrf
...
<table class="table table-bordered table-striped" style="color: #000000;" id="semillas_stock">
<thead>
<tr>
<th scope="col">Nombre</th>
...
<td style="text-align: center;">  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#editarstock{{$producto->id}}">Agregar</button>
<div id="editarstock{{$producto->id}}" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-dialog-centered">
   <div class="modal-content">
     ...
     <div class="modal-body">
       <form method="POST" action="{{ route('agregar_stock_semilla') }}">
           @csrf
         <div class="form-group row">
           <label for="nombre" class="col-md-4 col-form-label text-md-right">{{ __('Nombre') }}</label>
           <div class="col-md-6">
   ...
   <input hidden="hidden" name="id" id="id" value="{{ $producto->id}}">
        <div class="form-group row">
             <label for="nombre" class="col-md-4 col-form-label text-md-right">{{ __('Cantidad') }}</label>
           <div class="col-md-6">
  ...
  <div id="editarstock_q{{$producto->id}}" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
       ...
       <div class="modal-body">
         <form method="POST" action="{{ route('quitar_stock_semilla') }}">
             @csrf
