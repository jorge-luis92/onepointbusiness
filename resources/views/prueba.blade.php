...
<div class="container">
   ...
   <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab" aria-controls="settings" aria-selected="false">Productos</a>
         ...
         <option id="tipo" value="{{$tipo->id}}">{{ $tipo->nombre}}</option>
        @endforeach
                    </select>
                    <span >
              <!--    <button id="agregar_productos"  class="btn btn-danger" >-->
                      <button id="btngramoss"  class="btn btn-danger" >
                        <span>
                    <i class="fa fa-search" >Cantidad</i></span>
                       </button>
              ...
              <!--    <button id="agregar_productos"  class="btn btn-danger" >-->
                      <button id="btnpesos"  class="btn btn-danger" >
                        <span>
                    <i class="fa fa-search" >Pesos</i></span>
                       </button>
...
<div class="modal fade" id="gramosa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="form-group row">
        <label for="cantidad_gram" class="col-md-4 col-form-label text-md-right">{{ __('Ingrese cantidad: ') }}</label>

        <div class="col-md-6">
            <input id="cantidad_gram"  type="tel" maxlength="5" onkeypress="return numeros (event)"  class="form-control @error('cantidad_gram') is-invalid @enderror" name="cantidad_gram" value="{{ old('cantidad_gram') }}" required >
...
<div class="modal fade" id="pesosa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="cantidad_pes"  type="tel" maxlength="5" onkeypress="return numeros (event)"  class="form-control @error('cantidad_pes') is-invalid @enderror" name="cantidad_pes" value="{{ old('cantidad_pes') }}" required autocomplete="cantidad_pes" autofocus>
...
<div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                ...
                <a style="size: 1.0;"> <strong>Total del día: $ {{$pago}} &nbsp;&nbsp;&nbsp;&nbsp;</strong> <strong>Ganancia: $ {{$ganacias_dia}} </strong></a>
                <div class="tab-content">
                                  <div class="table-responsive">

                                    <table class="table table-bordered table-striped" style="color: #000000;" id="seranmisventas">
                                      <thead>
                                        <tr>
